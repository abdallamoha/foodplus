...
from foodplusapp.models import  Restaurant, Meal, Order, OrderDetails
from foodplusapp.serializers import RestaurantSerializer, MealSerializer, OrderSerializer
